attendService =(function(){
    ...
    function attend(data, callback){
        $.ajax({
            url : '/groupChallenge/attend/insert',
            type : 'post',
            data : data,
            success : function(){
                if(callback){
    ...
    function attendCheck(data, callback){
        $.ajax({
            url : '/groupChallenge/attend/check',
            type : 'get',
            data : data,
    ...
    function attendCancel(data, callback){
        $.ajax({
            url : '/groupChallenge/attend/delete',
            type: "delete",
            data : data,
            success : function(){
                if(callback){
    ...
    function challengeSuccess(data, callback){
        $.ajax({
            url : '/groupChallenge/attend/update',
            type : 'patch',
            data : data,
            success : function(){
                if(callback){
    ...
    function successCheck(data, callback){
        $.ajax({
            url : '/groupChallenge/attend/success-check',
            type : 'get',
            data : data,
            success : function(result){
                if(callback){
