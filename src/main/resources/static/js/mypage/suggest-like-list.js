...
suggestLikeService = (function (){
    function list(page, callback){
        $.ajax({
            url: '/mypage/suggest-like-list-content',
            type: 'get',
            data: page,
...
function listText(list) {
    let text = '';
    let suggestLikeDTOS = list.content;
    $(suggestLikeDTOS).each((i, suggestLikeDTO) => {
        text += `
                                                                                    ...
                                                                                    <a href="javascript:void(0)">
                                                                                        <div class="content-image">
                                                                                            <span class="content-image-span">
                                                                                                ...
                                                                                                `;
                                                                                                <!-- 사진 -->
                                                                                                if (suggestLikeDTO.suggestDTO.fileDTOS.length == 0 ||suggestLikeDTO.suggestDTO.fileDTOS == null || suggestLikeDTO.suggestDTO.fileDTOS == undefined) {
                                                                                                    ...
                                                                                                    for (let j = 0; j < suggestLikeDTO.suggestDTO.fileDTOS.length; j++) {
                                                                                                        if (suggestLikeDTO.suggestDTO.fileDTOS[j].fileType === "REPRESENTATIVE") {
                                                                                                            text += `<img src="/file/display?fileName=${suggestLikeDTO.suggestDTO.fileDTOS[j].filePath}/${suggestLikeDTO.suggestDTO.fileDTOS[j].fileUuid}_${suggestLikeDTO.suggestDTO.fileDTOS[j].fileOriginalName}">`;
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                     text +=           `</picture>
                                                                                        ...
                                                                                        <div class="content-title">
                                                                                            ${suggestLikeDTO.suggestDTO.boardTitle}
                                                                                        </div>
                                <!--                                                        <div class="content2">-->
                                <!--                                                            상시 이벤트-->
                                <!--                                                        </div>-->
                                                                                        <div class="liked-box">
                                                                                            <div class="flex">
                                                                                                <div class="liked-layout" id="heart${suggestLikeDTO.suggestDTO.id}">
                                                                                                    <div class="icon-box">
                                                                                                    ...
                                                                                                    <p class="like-count">${suggestLikeDTO.suggestDTO.likeCount}</p>
                                                                                                </div>
                                                                                                <div class="liked-layout">
                                                                                                    ...
                                                                                                    <p class="reply-count">${suggestLikeDTO.suggestDTO.replyCount}</p>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </a>
