...
function listText(list) {
    ...
    suggestLikeDTOS.forEach((suggestLikeDTO, i) => {
        text += `
                                                        ...
                                                        <div class="liked-box">
                                                            <div class="flex">
                                                                <div class="liked-layout">
                                                                    ...
                                                                    <p class="like-count">${suggestLikeDTO.likeCount}</p> 
                                                                </div>
                                                                <div class="liked-layout">
                                                                    <div class="icon-box">
                                                                    ...
                                                                    <p class="reply-count">${suggestLikeDTO.replyCount}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </a>
